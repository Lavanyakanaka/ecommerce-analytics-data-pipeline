...
CREATE INDEX idx_dim_customers_id ON warehouse.dim_customers(customer_id, is_current);
...
CREATE INDEX idx_dim_products_id ON warehouse.dim_products(product_id, is_current);
